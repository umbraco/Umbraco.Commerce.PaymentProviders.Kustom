...
{
    public abstract class KustomOrderBase
    {
        ...
        public List<KustomOrderLine> OrderLines { get; set; }
        ...
        public KustomAddress BillingAddress { get; set; }

        [JsonPropertyName("shipping_address")]
        public KustomAddress ShippingAddress { get; set; }

        public KustomOrderBase()
        {
            OrderLines = new List<KustomOrderLine>();
        }
    }
}
